"""Kaggle GPU cell: encode the 1.2 additions with the SAME frozen 576-token tokenizer.
...
WORK = "/kaggle/working"
SHARDS = ["gweird-prep-t2i-0", "gweird-prep-t2i-1", "gweird-prep-t2i-2", "gweird-prep-t2i-3"]
TAG = "gwtokC"
